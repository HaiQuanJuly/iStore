...
import print1 from "../../assets/product/print_1.png";
import print2 from "../../assets/product/print_2.png";
      ...
      <main className="bg-white rounded-xl p-6 sm:p-8">
        ...
        <div className="flex flex-wrap justify-between items-center px-4 sm:px-10 py-4">
          <div className="flex flex-wrap gap-2 sm:gap-4">
            {["Máy in 1", "Máy in 2", "Máy in 3"].map((series, index) => (
              <div
                key={index}
        ...
        <div className="flex items-center justify-between py-8">
          ...
          <div className="grid grid-cols-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-4 w-full max-w-[1400px] mx-auto">
            {[print1, print2, print1, print2, print1].map((print, index) => (
              <div
                key={index}
              ...
              >
                ...
                <div className="flex justify-center py-3">
                  {["#D5DDE0", "#EDD4D7", "#EEE9CC", "#D2DDCD", "#515558"].map(
                    (color, index) => (
                      <div
                        key={index}
